...
public class OrderServiceImpl implements OrderService {
    ...
    public String  findName(String name){
        return memberClient.findByName(name);
    }

    public int updatePwdById(Long memberId){
        memberClient.findByName("zk");
        return memberClient.updatePasswdById(memberId, String.valueOf((int) (Math.random() * 100 + 1)));
    }
